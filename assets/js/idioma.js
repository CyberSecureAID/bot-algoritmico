...
const DIC = {
  en: {
    ...
    /* === FUTURES === */
    'Cargando tus órdenes…': 'Loading your orders…',
    'Meses, no días. Si lo vas a necesitar pronto, esto no es para ese dinero.': "Months, not days. If you'll need it soon, this isn't for that money.",
    'No tienes órdenes pendientes': 'You have no pending orders',
    '3 vueltas en un día': '3 cycles in a day',
    'Conecta tu wallet para ver tu posición.': 'Connect your wallet to see your position.',
    'Conecta tu wallet para ver tus órdenes.': 'Connect your wallet to see your orders.',
    'Posición': 'Position',
    'Todavía no tienes operaciones. Cuando un bot o una orden se ejecute, aparecerá aquí.': 'You have no trades yet. When a bot or an order executes, it will show up here.',
    '✓ No hay permisos abiertos. Tu dinero solo se mueve si tú firmas.': '✓ No open permissions. Your money only moves if you sign.',
    'Órdenes limit que pusiste a mano desde el gráfico.': 'Limit orders you placed by hand from the chart.',
    '· orden limit desde el gráfico': '· limit order from the chart',
    '(pon tu inversión para afinar)': '(enter your investment to fine-tune)',
    'Escribe cuánto BNB quieres poner.': 'Type how much BNB you want to put in.',
    'Recargando… confirma en tu wallet.': 'Topping up… confirm in your wallet.',
    '¿cuánto ganaría con X?': 'how much would I earn with X?',
    'CRIPTOCUBAOFICIAL.COM   ·   SIN CUSTODIA   ·   SIN KYC': 'CRIPTOCUBAOFICIAL.COM   ·   NON-CUSTODIAL   ·   NO KYC',
    'Activando tu bot (firma el pago en tu wallet)…': 'Activating your bot (sign the payment in your wallet)…',
    'Activar tu bot (30 días)': 'Activate your bot (30 days)',
    'Ampliar el rango': 'Widen the range',
    'Calculado por tu % de ganancia y tu capital': 'Based on your profit % and your capital',
    'Calculando tu acumulador con el precio real…': 'Calculating your accumulator with the live price…',
    'Calculando tu rejilla con el precio real…': 'Calculating your grid with the live price…',
    'Cancelaste la firma. No se hizo ningún cambio.': 'You cancelled the signature. No changes were made.',
    'Cancelaste una firma.': 'You cancelled a signature.',
    'Cerrando el bot… confirma en tu wallet.': 'Closing the bot… confirm in your wallet.',
    'Cerrar Cash Out': 'Close Cash Out',
    'Comprobando tu saldo…': 'Checking your balance…',
    'Convirtiendo tu BNB… firma en tu wallet.': 'Converting your BNB… sign in your wallet.',
    'Descargar todas las operaciones del bot': 'Download all the bot trades',
    'Desconectar': 'Disconnect',
    'Desconectar bot': 'Disconnect bot',
    'Devolviendo tu BNB… confirma en tu wallet.': 'Returning your BNB… confirm in your wallet.',
    'El precio mínimo debe ser MENOR que el precio de ahora. Prueba "Sugerir".': 'The minimum price must be LOWER than the current price. Try "Suggest".',
    'Elige a qué % de ganancia vender.': 'Choose at what profit % to sell.',
    'Elige a qué % quieres vender.': 'Choose at what % you want to sell.',
    'Elige tu estable': 'Choose your stablecoin',
    'Encender': 'Turn on',
    'Encender Cash Out': 'Turn on Cash Out',
    'Encender el acumulador': 'Turn on the accumulator',
    'Espera a que cargue el precio y vuelve a intentar.': 'Wait for the price to load and try again.',
    'Ganancia por cuadrícula': 'Profit per grid',
    'Gas retirado.': 'Gas withdrawn.',
    'La activación del bot aún no está configurada. Avísame para revisarlo.': 'Bot activation is not set up yet. Let me know so I can check it.',
    'MIS ÓRDENES': 'MY ORDERS',
    'Mis órdenes': 'My orders',
    'Neto por vuelta': 'Net per cycle',
    'No tienes bots activos que cerrar.': 'You have no active bots to close.',
    'No tienes gas para retirar.': 'You have no gas to withdraw.',
    'Orden de venta': 'Sell order',
    'Pon al menos 2 compras.': 'Set at least 2 buys.',
    'Pon al menos 2 cuadrículas.': 'Set at least 2 grids.',
    'Preparando tu Cash Out con el precio real…': 'Preparing your Cash Out with the live price…',
    'Preparando tu DCA con el precio real…': 'Preparing your DCA with the live price…',
    'Preparar tu BNB': 'Prepare your BNB',
    'Registrando el permiso… firma en tu wallet.': 'Registering the permission… sign in your wallet.',
    'Retirando… confirma en tu wallet.': 'Withdrawing… confirm in your wallet.',
    'Revisa el rango: el precio alto debe ser mayor que el bajo. Prueba "Sugerir".': 'Check the range: the high price must be higher than the low. Try "Suggest".',
    'Sin límite': 'No limit',
    'Suspender': 'Pause',
    'Suspender DCA': 'Pause DCA',
    'Sí, activar': 'Yes, activate',
    'Sí, ampliar': 'Yes, widen',
    'Sí, encender': 'Yes, turn on',
    'Sí, suspender': 'Yes, pause',
    'Todas': 'All',
    'Tus órdenes': 'Your orders',
    'Vendiendo a estable… confirma en tu wallet.': 'Selling to stablecoin… confirm in your wallet.',
    'este bot ya no tiene órdenes': 'this bot has no orders left',
    'ganancia por cuadrícula': 'profit per grid',
    'máximo': 'maximum',
    'mínimo': 'minimum',
    'orden desde gráfico': 'order from chart',
    'precio': 'price',
    ...
    '¡Acumulador encendido!': 'Accumulator on!',
    '¡Bot encendido!': 'Bot on!',
    '¡Cash Out encendido!': 'Cash Out on!',
    '¡DCA encendido!': 'DCA on!',
    '¡Listo!': 'Done!',
    '¿Cuánto quieres comprar en cada compra?': 'How much do you want to buy each time?',
    '¿Cuánto quieres invertir?': 'How much do you want to invest?',
    '¿Cuánto quieres vender?': 'How much do you want to sell?',
    'Compra P2P': 'P2P Buy',
    'Vende lo que ya tienes al precio o % que elijas.': 'Sell what you already have at the price or % you choose.',
    'Abrir': 'Open',
    'Recibir': 'Receive',
    'COMPRA': 'BUY',
    'VENTA': 'SELL',
    'Descuento': 'Discount',
    'Cargando libro…': 'Loading order book…',
    'Capital disponible en tu wallet': 'Funds available in your wallet',
    'Ahora mismo no se pudo leer el historial (la red va lenta). Inténtalo de nuevo en un momento.': "Couldn't read the history right now (the network is slow). Try again in a moment.",
    'en tu wallet para vender.': 'in your wallet to sell.',
    'No tienes órdenes limit abiertas.': 'You have no open limit orders.',
    'Pon una desde la pestaña Limit.': 'Place one from the Limit tab.',
    'Asegura ganancia': 'Lock in profit',
    'Cambia cualquier cripto por otra, sin KYC y no custodial.': 'Swap any crypto for another, no KYC and non-custodial.',
    'Compra cantidades fijas cada cierto tiempo para promediar tu entrada.': 'Buy fixed amounts at regular intervals to average your entry.',
    'Compra en caídas': 'Buy the dips',
    'Compra por tramos cuando baja y arma posición sin que estés pendiente.': 'Buys in steps as it drops and builds your position hands-free.',
    'Detecta la mano fuerte: órdenes grandes y absorción.': 'Spot the smart money: large orders and absorption.',
    'Flujo órdenes': 'Order flow',
    'Fondo común': 'Community pool',
    'Formación paso a paso para sacarle ventaja al mercado.': 'Step-by-step training to gain an edge on the market.',
    'Gana en el rango': 'Profit in the range',
    'Mira dónde está la liquidez y los muros del mercado.': 'See where the liquidity and the market walls are.',
    'Niveles, indicadores y compra/venta al toque en la gráfica.': 'Levels, indicators and one-tap buy/sell on the chart.',
    'Participa y gana del pozo acumulado de la comunidad.': 'Join and win from the community prize pool.',
    'muros': 'walls',
    'Órdenes de compra y venta entre personas, con garantía.': 'Peer-to-peer buy and sell orders, with escrow.',
    'Acceso completo a los cursos.': 'Full access to the courses.',
    'Activación': 'Activation',
    'Conecta tu wallet para ver tu dirección de recepción.': 'Connect your wallet to see your receiving address.',
    'Dirección copiada al portapapeles.': 'Address copied to clipboard.',
    'Este servicio requiere activación para poder usarse.': 'This service requires activation before you can use it.',
    'La activación de pago se conectará con su contrato próximamente.': 'Paid activation will connect to its contract soon.',
    'Servicio premium': 'Premium service',
    'Gráficas (Liquidity Pools)': 'Charts (Liquidity Pools)',
    'Sin saldo': 'No balance',
    'Solo para análisis': 'Analysis only',
    'Historial de operaciones': 'Trade history',
    'Busca por símbolo…': 'Search by symbol…',
    'Sin resultados.': 'No results.',
    'Exchange no custodial · BNB Smart Chain': 'Non-custodial exchange · BNB Smart Chain',
    'Mi balance en CriptoCuba Oficial': 'My balance on CriptoCuba Oficial',
    'Cambio 24H': 'Chg 24H',
    'Índice': 'Index',
    'Máx 24H': 'High 24H',
    'Mín 24H': 'Low 24H',
    ...
    'Coste': 'Cost',
    'Solo actual': 'Current only',
    'Cerrar todo': 'Close all',
    'Elige un par': 'Choose a pair',
    'Liq.': 'Liq.',
    'Símbolo': 'Symbol',
    'Marca': 'Mark',
    'Abierto / Cerrado': 'Open / Close',
    'Orden Activador': 'Trigger order',
    '¿Qué es?': 'What is it?',
    'Para qué sirve': 'What it is for',
    'Riesgo bajo.': 'Low risk.',
    'Riesgo medio. Recomendado.': 'Medium risk. Recommended.',
    'Riesgo alto.': 'High risk.',
    'Riesgo extremo.': 'Extreme risk.',
    'El margen de esta posición está separado del resto. Si se liquida, solo pierdes lo asignado a ella.': 'The margin of this position is separate from the rest. If liquidated, you only lose what you assigned to it.',
    'Todo tu saldo respalda la posición. Aguanta más antes de liquidarse, pero puedes perder todo el saldo disponible.': 'Your whole balance backs the position. It holds longer before liquidation, but you can lose all available balance.',
    'Todo tu saldo respalda la posición. Aguanta más, pero puedes perder todo el saldo disponible.': 'Your whole balance backs the position. It holds longer, but you can lose all available balance.',
    'Abre una posición nueva: entras al mercado en largo o corto con el capital y apalancamiento que definas.': 'Opens a new position: you enter the market long or short with the capital and leverage you set.',
    'Cierra una posición que ya tienes abierta, tomando la ganancia o pérdida acumulada hasta ese momento.': 'Closes a position you already hold, taking the profit or loss accumulated so far.',
    'Abre una posición nueva en largo o corto con el capital y apalancamiento que definas.': 'Opens a new long or short position with the capital and leverage you set.',
    'Cierra una posición que ya tienes abierta, tomando la ganancia o pérdida acumulada.': 'Closes a position you already hold, taking the accumulated profit or loss.',
    'Una orden que solo se activa cuando el precio alcanza el nivel que tú marcas. Hasta entonces, queda en espera.': 'An order that only activates when the price reaches the level you set. Until then, it waits.',
    'Una orden que solo se activa cuando el precio alcanza el nivel que marcas. Hasta entonces queda en espera.': 'An order that only activates when the price reaches the level you set. Until then it waits.',
    'Entrar automáticamente si el mercado llega a cierto precio, sin tener que estar pendiente de la pantalla.': 'Enter automatically if the market reaches a certain price, without watching the screen.',
    'Entrar automáticamente si el mercado llega a cierto precio, sin estar pendiente de la pantalla.': 'Enter automatically if the market reaches a certain price, without watching the screen.',
    'Tu wallet': 'Your wallet',
    'Saldo USDT': 'USDT balance',
    'Fecha': 'Date',
    'No conectada': 'Not connected',
    'Exportar gráfica': 'Export chart',
