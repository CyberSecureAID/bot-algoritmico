...
const COMO_TEXTO = [
  '<b>How your capital works, and why it is never at risk</b>',
  '',
  'Before you provide a single dollar, you deserve to understand exactly what happens to your money, where every dollar of return comes from, and why your capital is never handed to anyone. Read this in full. By the end you will see that this is one of the safest ways to put your capital to work in crypto.',
  '',
  '<b>Your capital never leaves your control</b>',
  'When you stake, your funds rest inside a public, audited smart contract that only your signature can move. The platform cannot spend it, cannot withdraw it, and cannot lend it away to anyone. It stays there as your capital, in the exact coin you deposited, until you decide to withdraw at the end of your chosen period. Whatever you put in comes back to you: one Bitcoin in, one Bitcoin out, plus everything it earned.',
  '',
  '<b>So where do the returns come from?</b>',
  'Your capital is the liquidity that makes our Futures market possible. A trader who wants to open a leveraged position needs size that they do not have on their own, so the contract provides that size from the pool. This is the part most people misunderstand, so read it carefully: the trader never receives, touches, or can withdraw that borrowed capital. It is handled entirely inside the contract, in the same instant the position opens, purely to back that one position. It is never given away. It never leaves the system.',
  '',
  '<b>A real example, a long position</b>',
  'A trader opens a long on Bitcoin with 10 dollars of their own margin at 100x. That is 1,000 dollars of exposure. The contract takes 1,000 dollars of liquidity and buys Bitcoin at the entry price. That purchased Bitcoin is the backing of the position; it is still capital, simply held as the asset. If Bitcoin rises 1 percent, the position is worth 1,010: the 1,000 returns to the pool untouched, and the trader keeps 10 dollars of profit. That profit came from the market rising, not from another user and not from the pool. If Bitcoin instead falls, the trader loses their own 10 dollars first, and that loss is used to top up exactly what the loan lost, so the pool is made whole to the cent. The position is closed the moment the loss reaches the trader margin. The provider of the liquidity always gets their full amount back.',
  '',
  '<b>How a short works</b>',
  'A short is the mirror image, and here is the key: a short is backed by the coin itself, not by dollars. The pool lends the coin and it is sold immediately at the entry price. If the price falls, the coin is bought back cheaper to return it to the pool, and the difference is the trader profit. If the price rises, the trader own margin covers the difference. Either way the pool receives its coin back in full. This is why the coins that people stake decide what can be traded: for shorts of a coin to exist, that coin must be in the pool. Your liquidity in every coin directly enables the market.',
  '',
  '<b>Why you can never lose your principal</b>',
  'In both directions, a winning trade is paid by the market move, and a losing trade tops up the loan. Leverage is always kept proportional to the liquidity available, so a trader maximum possible loss can never exceed what the loan lost. There is no scenario where the pool ends up short. Your principal is mathematically protected and returned in your own coin.',
  '',
  '<b>What you earn, in detail</b>',
  'You earn from real platform activity, not from promises. Every time a position opens and closes, a fee is charged, and while a position stays open it pays a periodic funding fee. All of these are split fifty fifty between the people who provide liquidity and the platform. When a position is liquidated, seventy five percent tops up the liquidity that was used and the remaining twenty five percent is split fifty fifty. On top of all of that, everyone who stakes receives twenty percent of everything the entire platform generates across every service, and fifty percent of everything the Futures market generates. It is all distributed strictly in proportion to how much each person provides: someone who stakes one million earns one million times more than someone who stakes one dollar, exactly and automatically.',
  '',
  '<b>And your coin can also grow</b>',
  'You choose how your capital rests. Keep it in your coin and, on top of your rewards, you also gain if that coin rises in price, shown to you as a separate price gain. Or convert it to USDT to stay perfectly stable with no exposure to price. Either way, your rewards keep flowing.',
  '',
  '<b>In short</b>',
  'Your money stays yours, in your coin, under your control. It quietly powers a real market, it is never given to anyone, and it earns you a share of everything the platform makes. This is how serious capital works here.'
].join('<br>');
const TIPS={
