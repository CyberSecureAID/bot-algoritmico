...
import { montarAportar } from '../aportar.js?v=8';
export function abrirAportarMovil(){
  ...
  dg.style.cssText='margin:0;padding:0;border:0;max-width:100vw;max-height:100vh;width:100vw;height:100vh;background:rgba(5,7,10,.94);overflow-y:auto;overflow-x:hidden;-webkit-overflow-scrolling:touch;color:inherit';
