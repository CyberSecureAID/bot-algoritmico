...
export function estilos() {
  ...
  #mk-overlay .mk-card{width:100%;max-width:780px;max-height:92vh;overflow:auto;background:linear-gradient(180deg,rgba(18,22,28,.82),rgba(11,14,18,.88));border:1px solid #2b3139;border-radius:20px;box-shadow:0 40px 120px rgba(0,0,0,.72);padding:24px;position:relative;animation:mkIn .18s ease both}
  #mk-overlay .mk-card::after{content:"";position:fixed;inset:0;z-index:0;background-image:url('assets/portada/img/swap-bg.webp');background-size:cover;background-position:center;opacity:.10;filter:saturate(1.05);pointer-events:none;}
  ...
  @media(max-width:560px){
    ...
    /* ── Disclaimer P2P ── */
  #mk-card .mk-disc{display:flex !important;flex-direction:column !important;max-height:100% !important;padding:6px 2px !important;height:100%}
  #mk-card .mk-disc-t{font-family:var(--display,'Segoe UI',sans-serif) !important;font-weight:800 !important;font-size:21px !important;color:#f3f6fa !important;text-align:center !important;margin:4px 0 16px !important;flex:none}
  #mk-card .mk-disc-body{overflow-y:auto !important;flex:1 1 auto !important;min-height:0;padding-right:8px}
  #mk-card .mk-disc-body p{font-size:13.5px !important;line-height:1.65 !important;color:#c9d2dc !important;margin:0 0 13px !important;text-align:left !important;text-transform:none !important;letter-spacing:normal !important}
  #mk-card .mk-disc-body b{color:#f3f6fa !important;font-weight:700 !important}
  #mk-card .mk-disc-chk{display:flex !important;align-items:flex-start !important;gap:9px !important;margin:14px 0 12px !important;font-size:13px !important;color:#d4dbe4 !important;cursor:pointer;line-height:1.45;flex:none;text-transform:none !important;letter-spacing:normal !important;font-family:var(--display,sans-serif) !important}
  #mk-card .mk-disc-chk input{margin-top:2px;width:17px !important;height:17px !important;flex:none;accent-color:#E8B84B;cursor:pointer}
  #mk-card .mk-disc-btn{width:100% !important;padding:14px !important;border:0 !important;border-radius:13px !important;background:linear-gradient(180deg,#f7db8d,#E8B84B 55%,#c79426) !important;color:#3a2800 !important;font-family:var(--display,sans-serif) !important;font-weight:800 !important;font-size:15px !important;cursor:pointer;flex:none;text-transform:none !important;letter-spacing:normal !important}
  #mk-card .mk-disc-btn:disabled{opacity:.4 !important;cursor:not-allowed}
  @media(max-width:560px){ #mk-card .mk-disc-t{font-size:19px !important} #mk-card .mk-disc-body p{font-size:13px !important} }
`;
